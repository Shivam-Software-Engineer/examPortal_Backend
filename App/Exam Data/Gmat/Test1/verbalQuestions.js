const test1VerbalQuestions = [
  ...
  },
  {
    ...
    type: 'RC',
    difficulty: "medium",
    passage: `<b>The first and most important subject lying at the very threshold of the investigation, is the freedom of the human will.</b> On the establishing of this doctrine depends the whole question of human responsibility, and yet <b>it is a doctrine which Aristotle could not assume at once, because views had been held respecting it which required refutation. </b>Socrates had held that all the virtues were sciences; therefore, that vice was the result of ignorance; that no one sins contrary to knowledge; and therefore, that vice is involuntary. Plato held that virtue was voluntary, because the natural bias of the will was towards good, but that a vicious state was an unnatural one—a morbid action, as it were, and therefore involuntary. Aristotle agreed with Plato so far as to maintain that a bias towards virtue is the normal condition of the will.`,
...
export default test1VerbalQuestions;
